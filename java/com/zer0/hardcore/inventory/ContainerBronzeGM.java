...
public class ContainerBronzeGM extends Container {

	private TileEntityBronzeGM tileGM;
	private int lastCookTime;
	private int lastItemBurnTime;
	private int lastBurnTime;
	
	public ContainerBronzeGM(InventoryPlayer player, TileEntityBronzeGM tileEntityGM)
	{
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int par2){
		...
		if(slot != null && slot.getHasStack()){
			...
			if(par2 == 2){
				...
				}else if(TileEntityBronzeGM.isItemFuel(itemstack1)){
