...
import com.zer0.hardcore.blocks.BronzeGrindingMachine;
...
public class TileEntityBronzeGM extends TileEntity implements ISidedInventory {
	...
	{
		return this.hasCustomInventoryName() ? this.furnaceName : "Bronze Grinding Machine";
	}
	...
	public void updateEntity()
	{
		...
		{
			flag1 = true;
			BronzeGrindingMachine.updateBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
		}
		if(flag1)
		{
			this.markDirty();
